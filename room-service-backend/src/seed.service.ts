  ...
  async onApplicationBootstrap() {
    ...
    const hkTasks: Partial<HousekeepingTask>[] = [
      ...
      },
      {
        ...
        deadline: daysLater(1), completedAt: daysAgo(0),
      ...
      },
      {
        ...
        deadline: daysAgo(1), completedAt: daysAgo(2),
      ...
      },
      {
        ...
        deadline: daysAgo(2), completedAt: daysAgo(3),
      ...
      },
      {
        ...
        deadline: daysLater(0), completedAt: daysAgo(0),
    ...
    const mTickets: Partial<MaintenanceTicket>[] = [
      ...
      },
      {
        ...
        staffId: savedMaintenance[3].id, deadline: daysAgo(1), resolvedAt: daysAgo(2),
      ...
      },
      {
        ...
        staffId: savedMaintenance[2].id, deadline: daysAgo(3), resolvedAt: daysAgo(4),
      ...
      },
      {
        ...
        staffId: savedMaintenance[4].id, deadline: daysAgo(5), resolvedAt: daysAgo(6),
